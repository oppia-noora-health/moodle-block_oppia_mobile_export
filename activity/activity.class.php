...
abstract class MobileActivity {
    ...
    public function __construct($params=array()) {
        ...
        if (isset($params['activity_time'])) {
            $this->activity_time = $params['activity_time'];
        }
    ...
    protected function get_activity_node($xmldoc, $module, $counter) {
    	$activity_time = get_oppiaconfig(intval($module->id), 'activity_time', '', true, $server);
        ...
        $act->appendChild($xmldoc->createAttribute("activity_time"))->appendChild($xmldoc->createTextNode($activity_time));
